...
class Seeder:
  ...
  def load_peers(self):
    ...
    req = requests.get(tracker_url, proxies=proxies, params=http_params, headers=self.HTTP_HEADERS, timeout=10)
  ...
  def upload(self, uploaded_bytes):
    ...
    requests.get(tracker_url, proxies=proxies,params=http_params, headers=self.HTTP_HEADERS, timeout=10)
